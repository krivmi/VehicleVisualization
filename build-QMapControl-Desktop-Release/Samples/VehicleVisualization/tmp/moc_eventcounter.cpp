...
#include <memory>
#include "../../../../Samples/VehicleVisualization/src/eventcounter.h"
...
QT_MOC_LITERAL(1, 13, 11), // "messageShow"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5), // "index"
QT_MOC_LITERAL(4, 32, 14), // "messagesPlayed"
QT_MOC_LITERAL(5, 47, 14), // "playingStarted"
QT_MOC_LITERAL(6, 62, 4) // "tick"

    },
    "EventCounter\0messageShow\0\0index\0"
    "messagesPlayed\0playingStarted\0tick"
};
...
void EventCounter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->messageShow((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->messagesPlayed(); break;
        case 2: _t->playingStarted(); break;
        ...
        {
            using _t = void (EventCounter::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventCounter::messageShow)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (EventCounter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventCounter::messagesPlayed)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (EventCounter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventCounter::playingStarted)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void EventCounter::messageShow(int _t1)
{
...
// SIGNAL 1
void EventCounter::messagesPlayed()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void EventCounter::playingStarted()
{
