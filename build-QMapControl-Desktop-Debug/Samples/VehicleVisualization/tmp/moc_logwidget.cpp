...
#include <memory>
#include "../../../../Samples/VehicleVisualization/src/logwidget.h"
...
QT_MOC_LITERAL(3, 19, 24), // "std::shared_ptr<Message>"
QT_MOC_LITERAL(4, 44, 7), // "message"
QT_MOC_LITERAL(5, 52, 16), // "lifeTimeExceeded"
QT_MOC_LITERAL(6, 69, 10) // "updateTime"

    },
    "LogWidget\0clicked\0\0std::shared_ptr<Message>\0"
    "message\0lifeTimeExceeded\0updateTime"
};
...
void LogWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< std::shared_ptr<Message>(*)>(_a[1]))); break;
        case 1: _t->lifeTimeExceeded((*reinterpret_cast< std::shared_ptr<Message>(*)>(_a[1]))); break;
        ...
        {
            using _t = void (LogWidget::*)(std::shared_ptr<Message> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogWidget::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LogWidget::*)(std::shared_ptr<Message> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogWidget::lifeTimeExceeded)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LogWidget::clicked(std::shared_ptr<Message> _t1)
{
...
// SIGNAL 1
void LogWidget::lifeTimeExceeded(std::shared_ptr<Message> _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
