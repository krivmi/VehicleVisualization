...
namespace qmapcontrol
{
    ...
    QMapControl::QMapControl(const QSizeF& size_px, QWidget* parent, Qt::WindowFlags window_flags)
        : QWidget(parent, window_flags),
          ...
          m_zoom_minimum(12),
          m_zoom_maximum(19), // 19 is maximum
          ...
          m_recenter_GPS_point_button(QIcon(":/resources/images/location.png"), "", this)
    {
        // Register meta types.
    ...
    void QMapControl::enableZoomControls(const bool& enable, const bool& align_left)
    {
        ...
        m_recenter_GPS_point_button.setVisible(enable);
        ...
        QObject::disconnect(&m_recenter_GPS_point_button, 0, this, 0);
        ...
        QObject::connect(&m_recenter_GPS_point_button, &QPushButton::clicked, this, &QMapControl::recenterGPSPoint);
    ...
    void QMapControl::mouseReleaseEvent(QMouseEvent* mouse_event)
    {
                ...
                mouse_mode == QMapControl::MouseButtonMode::SelectEllipse)
        {
            ...
            std::unique_ptr<Geometry> geometry_to_compare_coord(new GeometryPolygon(RectWorldCoord(top_left_coord, bottom_right_coord).toStdVector(), m_zoom_minimum, m_zoom_maximum));
            if(mouse_mode == QMapControl::MouseButtonMode::SelectLine)
            {
                ...
                geometry_to_compare_coord.reset(new GeometryLineString(std::vector<PointWorldCoord>{top_left_coord, bottom_right_coord}, m_zoom_minimum, m_zoom_maximum));
...
//                        if(geometry->touches(*(area_px.get()), m_current_zoom))
    ...
    void QMapControl::redrawBackbuffer()
    {
        ...
        if(m_backbuffer_queued_mutex.tryLock())
        {
            ...
            //painter_back_buffer.rotate(45.0);
