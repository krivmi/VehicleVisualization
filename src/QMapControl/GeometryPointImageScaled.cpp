...
namespace qmapcontrol
{
    ...
    void GeometryPointImageScaled::drawShapeScale(QPainter &painter, const RectWorldPx &rect, qreal scale)
    {
        painter.drawPixmap(-rect.rawRect().width() / (2.0 * scale) , -rect.rawRect().height() / (2.0 * scale), image());
    }
