...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        explicit GeometryLineString(const std::vector<PointWorldCoord>& points, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
        explicit GeometryLineString(int zoom_min = 0, int zoom_max = 19);
