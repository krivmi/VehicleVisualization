...
namespace qmapcontrol
{
    ...
    MapAdapterOSM::MapAdapterOSM(QObject* parent)
        ...
        : MapAdapterTile(QUrl("http://tile.openstreetmap.org/%zoom/%x/%y.png"), supportedProjections(), 0, 20, 0, false, parent) /// @todo remove once MSVC supports initializer lists.
    {
