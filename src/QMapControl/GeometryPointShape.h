...
namespace qmapcontrol
{
    ...
    protected:
         ...
         */
        GeometryPointShape(const qreal& longitude, const qreal& latitude, const QSizeF& size_px, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
         ...
         * @param zoom_maximum The maximum zoom level to show this geometry at.
         */
        GeometryPointShape(const PointWorldCoord& point_coord, const QSizeF& size_px, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
