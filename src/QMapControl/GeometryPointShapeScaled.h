...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        GeometryPointShapeScaled(const qreal& longitude, const qreal& latitude, const QSizeF& base_size_px, const int& base_zoom, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
         ...
         * @param zoom_maximum The maximum zoom level to show this geometry at.
         */
        GeometryPointShapeScaled(const PointWorldCoord& point_coord, const QSizeF& base_size_px, const int& base_zoom, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
    ...
    protected:
        ...
        virtual void drawShapeScale(QPainter &painter, const RectWorldPx &rect, qreal scale) = 0;
