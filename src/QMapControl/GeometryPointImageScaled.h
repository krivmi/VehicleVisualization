...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        GeometryPointImageScaled(const PointWorldCoord& point_coord, const std::shared_ptr<QPixmap>& image, const int& base_zoom, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
         ...
         * @param zoom_maximum The maximum zoom level to show this geometry at.
         */
        GeometryPointImageScaled(const PointWorldCoord& point_coord, const QPixmap& image, const int& base_zoom, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
         ...
         * @param zoom_maximum The maximum zoom level to show this geometry at.
         */
        GeometryPointImageScaled(const PointWorldCoord& point_coord, const std::string& filename, const int& base_zoom, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
    ...
    protected:
        ...
        virtual void drawShapeScale(QPainter &painter, const RectWorldPx &rect, qreal scale);
