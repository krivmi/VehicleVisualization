...
namespace qmapcontrol
{
    ...
    */
    ...
    public:
        ...
        */
        GeometryWidget(const qreal& longitude, const qreal& latitude, QWidget* widget, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
        ...
        * @param zoom_maximum The maximum zoom level to show this geometry at.
        */
        GeometryWidget(const PointWorldCoord& point_coord, QWidget* widget, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
