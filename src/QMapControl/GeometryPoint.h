...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        GeometryPoint(const qreal& longitude, const qreal& latitude, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
         ...
         * @param zoom_maximum The maximum zoom level to show this geometry at.
         */
        GeometryPoint(const PointWorldCoord& point_coord, const int& zoom_minimum = 0, const int& zoom_maximum = 19);
